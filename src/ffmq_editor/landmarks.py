...
START=0xe7000  # Bank $1C, beyond all 16 private metatile sets.
BASE=0x3eb44
COUNT=143
...
def writes(p):
 ...
 result.append((address,b'\xa9\x1c','landmark data bank'))
 for i,a in enumerate(LOADS):
  ...
  result.append((at,b'\xbd'+(0xf000+i).to_bytes(2,'little'),'landmark table field'))
 return result
