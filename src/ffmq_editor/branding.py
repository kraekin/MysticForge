...
def about(w):
    ...
    for text in ('A map and game-data editor for Final Fantasy Mystic Quest. Explore terrain, objects, connections, shared graphics, and game events.',
                 'Supports the original unheadered USA v1.0 ROM. Save your work as a project and export a separate ROM copy. Event and script inspection is currently read-only.',
